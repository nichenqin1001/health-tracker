...
var FoodModel = _backbone.Model.extend({
...
var FoodsCollections = _backbone.Collection.extend({

    model: FoodModel,

    localStorage: new _backbone.LocalStorage('foods')

});

var foods = new FoodsCollections();

var SelectedFoodsCollection = _backbone.Collection.extend({

    model: FoodModel,

    localStorage: new _backbone.LocalStorage('selected-foods')
...
var _foodView = __webpack_require__(13);

var _foodView2 = _interopRequireDefault(_foodView);

var _selectedFoodView = __webpack_require__(14);

var _selectedFoodView2 = _interopRequireDefault(_selectedFoodView);

var _foodModel = __webpack_require__(4);

var _appTemplate = __webpack_require__(28);
...
exports.default = _backbone.View.extend({
    ...
    initialize: function initialize() {
        ...
        this.$inputTextAlert = (0, _jquery2.default)('#inputTextAlert');
        this.$foodsList = (0, _jquery2.default)('#foods');
        this.$selectedList = (0, _jquery2.default)('#selected');
        this.$stats = (0, _jquery2.default)('#stats');
        this.$loader = (0, _jquery2.default)('#loader');

        this.listenTo(_foodModel.foods, 'add', this.addOne);
        this.listenTo(_foodModel.selectedFoods, 'add', this.addSelected);
        this.listenTo(_foodModel.selectedFoods, 'all', this.render);

        // get localstorage
        _foodModel.foods.fetch();
        _foodModel.selectedFoods.fetch();
    },
     ...
     * @param {any} food 
     */
    addOne: function addOne(food) {

        var foodView = new _foodView2.default({ model: food });
     ...
     * @param {any} food 
     */
    addSelected: function addSelected(food) {

        var selectedFoodView = new _selectedFoodView2.default({ model: food });
        this.$selectedList.append(selectedFoodView.render().$el);
    },
    getData: function getData() {
        var _this = this;

        var searchFoodText = (0, _jquery2.default)('#search-food-text').val();
        ...
        _jquery2.default.getJSON('https://api.nutritionix.com/v1_1/search/' + searchFoodText + '?', {
            'results': '0:15',
            ...
            // hide loader
            _this.$loader.empty();
            _foodModel.foods.reset();

            var results = data.hits;
            (0, _underscore.each)(results, function (food, index) {

                var newFood = new _foodModel.FoodModel({
                    name: food.fields.item_name,
                    calories: food.fields.nf_calories,
                    id: index
                });

                _foodModel.foods.create(newFood);
            });
        }).fail(function () {

            _this.$loader.empty();
            _this.$foodsList.html('<div class="alert alert-danger alert-dismissible" role="alert">' + 'Oops! Search failed! Please check your connection or proxy setting and try again!' + '</div>');
        });
    },
    clearData: function clearData() {

        (0, _underscore.invoke)(_foodModel.foods.toArray(), 'destroy');
        this.$foodsList.empty();
    },
...
var _foodTemplate = __webpack_require__(29);

var _foodTemplate2 = _interopRequireDefault(_foodTemplate);
...
exports.default = _backbone.View.extend({
    ...
    template: _foodTemplate2.default,
     ...
     * 
     */
    addFoodToSelected: function addFoodToSelected(e) {
        ...
        var newSelectedFood = new _foodModel.FoodModel({
            name: this.model.get('name'),
            calories: this.model.get('calories')
        });

        _foodModel.selectedFoods.create(newSelectedFood);
    }
});
...
var _selectedFoodTemplate = __webpack_require__(30);

var _selectedFoodTemplate2 = _interopRequireDefault(_selectedFoodTemplate);
...
exports.default = _backbone.View.extend({
    ...
    template: _selectedFoodTemplate2.default,
...
((__t=( calories ))==null?'':__t)+
'   <span class="label label-primary">Cal</span></h3>\r\n    </div>\r\n</div>\r\n';
}
return __p;
};
...
'\r\n    ';
 if (calories>100) { 
__p+='\r\n        <span class="label label-warning calories">'+
((__t=( calories ))==null?'':__t)+
' cal</span>\r\n        ';
 } else { 
__p+='\r\n            <span class="label label-success calories">'+
((__t=( calories ))==null?'':__t)+
' cal</span>\r\n            ';
 } 
__p+='\r\n                <button class="btn btn-info btn-xs pull-right add-food">Add</button>\r\n';
}
return __p;
};
...
__p+='\r\n                <button class="btn btn-danger btn-xs pull-right delete-food">Remove</button>\r\n';
}
return __p;
};
